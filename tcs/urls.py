...
urlpatterns = patterns('tcs.views',
	...
	url(r'^problems/(?P<slug>[A-Za-z0-9-]+)/solutions/(?P<solution_id>\d+)/implementations/create/$', 'implementation_add', name = 'implementation-add'),
	url(r'^problems/(?P<slug>[A-Za-z0-9-]+)/solutions/(?P<solution_id>\d+)/implementations/(?P<pk>\d+)/modify/$', 'implementation_modify', name = 'implementation-modify'),
	url(r'^problems/(?P<slug>[A-Za-z0-9-]+)/solutions/(?P<solution_id>\d+)/implementations/(?P<pk>\d+)/delete/$', 'implementation_delete', name = 'implementation-delete'),
	url(r'^problems/(?P<slug>[A-Za-z0-9-]+)/solutions/(?P<solution_id>\d+)/implementations/(?P<pk>\d+)/accept/(?P<value>[a-z]{3})/$', 'implementation_accept', name = 'implementation-accept'),
    # Examples:
